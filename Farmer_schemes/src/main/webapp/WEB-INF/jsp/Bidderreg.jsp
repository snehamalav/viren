...
<form id="regForm" action="Bidderregister.do" modelAttribute="ibidder" method="post" enctype="multipart/form-data">
  <h1>Bidder Registration:</h1>
  <!-- One "tab" for each step in the form: -->
  <div class="tab">Personal Details
    <p><input type="text" placeholder="Full Name"   name="full_name" required/></p>
    <p><input type="number" placeholder="Contact No"   name="contact_no" required/></p>
    <p><input type="email" placeholder="E-mail..."   name="b_email" required/></p>
  </div>
